...
"""
    ...
    env_path = '/home/Omnibot/omnibot/.env'
...
def show_trades(days=2, symbol=None, export=None):
    ...
    try:
        ...
        for _, trade in trades.iterrows():
            ...
            print(f"{time_str:<20} {trade['symbol']:<8} {trade['side']:<6} {trade['qty']:<8} ${trade['entry_price']:<9.2f} {exit_str:<10} {pnl_str:<12}")
...
def main():
    ...
    parser.add_argument('--mode', choices=['cli', 'gui', 'backtest'], default='cli', help='Run mode')
    parser.add_argument('--setup', action='store_true', help='Run initial setup')
    parser.add_argument('--trades', action='store_true', help='Show recent trades (last 2 days)')
    parser.add_argument('--days', type=int, default=2, help='Number of days for trade history')
    parser.add_argument('--symbol', type=str, default=None, help='Filter trades by symbol')
    parser.add_argument('--export', type=str, default=None, help='Export trades to file (csv/json)')
